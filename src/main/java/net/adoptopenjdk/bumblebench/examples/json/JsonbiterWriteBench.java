 ...
 * <br>
 * JsonbiterWriteBench score: 173.149429 (173.1 515.4%)
 *                 uncertainty:   0.4%
 * <br>
 * HotSpot Java 26 (Azul):
 * <br>
 * JsonbiterWriteBench score: 208.467667 (208.5 534.0%)
 *                 uncertainty:   0.7%
 */
public final class JsonbiterWriteBench extends MiniBench {
	@Override
	...
	public static void main(String[] args) {
		...
		new HeadlessFiles().local("jsonbiter.json").writeString(JsonStream.serialize(config, big), false);
	}
