 ...
 * <br>
 * JsonbiterBase64ReadBench score: 277.059357 (277.1 562.4%)
 *                      uncertainty:   0.2%
 * <br>
 * HotSpot Java 26 (Azul):
 * <br>
 * JsonbiterBase64ReadBench score: 319.161346 (319.2 576.6%)
 *                      uncertainty:   7.2%
 */
public final class JsonbiterBase64ReadBench extends MiniBench {
	static {
	...
	protected long doBatch(long numLoops, int numIterationsPerLoop) throws InterruptedException {
		String data = new HeadlessFiles().local("jsonbiterbase64.json").readString();
