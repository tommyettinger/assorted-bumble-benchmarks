 ...
 * HotSpot Java 8:
 * <br>
 * MurkRandomBench score: 631177088.000000 (631.2M 2026.3%)
 *             uncertainty:   2.5%
 * <br>
 * OpenJ9 Java 15:
 * <br>
 * MurkRandomBench score: 679122112.000000 (679.1M 2033.6%)
 *             uncertainty:   0.7%
 * <br>
 * HotSpot Java 16 (AdoptOpenJDK):
 * <br>
 * MurkRandomBench score: 1163576320.000000 (1.164G 2087.5%)
 *             uncertainty:   1.6%
 * <br>
 * HotSpot Java 17 (SAP Machine):
 * <br>
 * MurkRandomBench score: 1098123392.000000 (1.098G 2081.7%)
 *             uncertainty:   1.1%
 */
public final class MurkRandomBench extends MicroBench {

	public static class MurkRandom extends Random {
		...
		public MurkRandom(long stateA, long stateB, long stateC, long stateD) {
			super(stateA);
			this.stateA = stateA;
			this.stateB = stateB;
			this.stateC = stateC;
		...
		protected int next(int bits) {
			...
			stateA = (fd << 17 | fd >>> 64 - 17) ^ fc;
			stateB = (fa << 59 | fa >>> 64 - 59) + fd;
			stateC = (fb << 41 | fb >>> 64 - 41) ^ fa;
			stateD = (fc << 11 | fc >>> 64 - 11) + 0xC6BC279692B5C323L;
		...
		public long nextLong() {
			...
			stateC = (fb << 41 | fb >>> 64 - 41) ^ fa;
			stateD = (fc << 11 | fc >>> 64 - 11) + 0xC6BC279692B5C323L;
//			stateA = (fd << 17 | fd >>> 64 - 17) ^ fb;
//			stateB = (fa << 59 | fa >>> 64 - 59) ^ fc;
//			stateC = (fb << 41 | fb >>> 64 - 41) ^ fa;
//			stateD += 0xC6BC279692B5C323L;
			return fa;
		}
...
//			long count = 0xffffffL;
			...
			MurkRandom rand = new MurkRandom(1234567L);
 ...
 */
	...
	protected long doBatch(long numIterations) throws InterruptedException {
		MurkRandom rng = new MurkRandom(0x12345678);
		long sum = 0L;
