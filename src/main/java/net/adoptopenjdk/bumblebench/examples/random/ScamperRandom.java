...
/**
 */
public class ScamperRandom extends EnhancedRandom {
	@Override
	...
	/**
	 * Creates a new ScamperRandom with a random state.
	 */
	public ScamperRandom() {
	...
	/**
	 * Creates a new ScamperRandom with the given seed; all {@code long} values are permitted.
	 * The seed will be passed to {@link #setSeed(long)} to attempt to adequately distribute the seed randomly.
	 *
	 * @param seed any {@code long} value
	 */
	public ScamperRandom(long seed) {
		setSeed(seed);
	}

	/**
	 * Creates a new ScamperRandom with the given two states; all {@code long} values are permitted.
	 * These states will be used verbatim for stateA and stateB. Both stateC and stateD will be assigned 1.
	 *
	 * @param stateA any {@code long} value
	 * @param stateB any {@code long} value
	 */
	public ScamperRandom(long stateA, long stateB) {
		this.stateA = stateA;
		this.stateB = stateB;
		this.stateC = 1L;
		this.stateD = 1L;
	...
	/**
	 * Creates a new ScamperRandom with the given four states; all {@code long} values are permitted.
	 ...
	 */
	public ScamperRandom(long stateA, long stateB, long stateC, long stateD) {
		this.stateA = stateA;
		this.stateB = stateB;
		this.stateC = stateC;
		this.stateD = stateD;
...
//		x ^= x >>> 27;
	...
	public long skip(long advance) {
		final long a = (stateA += 0xDB4F0B9175AE2165L * advance);
...
//		x ^= x >>> 27;
	...
	@Override
	public ScamperRandom copy () {
		return new ScamperRandom(stateA, stateB, stateC, stateD);
	}
	...
	public boolean equals (Object o) {
		...
		ScamperRandom that = (ScamperRandom)o;

		return stateA == that.stateA && stateB == that.stateB && stateC == that.stateC && stateD == that.stateD;
	}

	public String toString () {
		return "ScamperRandom{" + "stateA=" + (stateA) + "L, stateB=" + (stateB) + "L, stateC=" + (stateC) + "L, stateD=" + (stateD) + "L}";
	}

//	public static void main(String[] args) {
//		ScamperRandom random = new ScamperRandom(1L);
