...
/**
 * Like PasarRandom, but without multiplication.
 */
public class FinchRandom extends EnhancedRandom {
	@Override
	 ...
	 */
	public FinchRandom(long stateA, long stateB, long stateC, long stateD, long stateE) {
		this.stateA = stateA;
		this.stateB = stateB;
		this.stateC = stateC;
		this.stateD = stateD;
	...
	public long previousLong () {
		...
		final long fe = stateE;
		stateB = (fc >>> 25 | fc << 39);
		stateD -= 0xF1357AEA2E62A9C5L;
		stateA = (fb ^ stateB) - stateD;
		stateC = fe - stateA;
		return stateE = (fa >>> 50 | fa << 14);
	}
	...
	@Override
	public FinchRandom copy () {
		return new FinchRandom(stateA, stateB, stateC, stateD, stateE);
	}
	...
	public boolean equals (Object o) {
		...
		FinchRandom that = (FinchRandom)o;
	...
	public String toString () {
		return "FinchRandom{" + "stateA=" + (stateA) + "L, stateB=" + (stateB) + "L, stateC=" + (stateC) + "L, stateD=" + (stateD) + "L, stateE=" + (stateE) + "L}";
	}

//	public static void main(String[] args) {
//		FinchRandom random = new FinchRandom(0L);
