 ...
 * ensures its long period. Has an exact period of 2 to the 128. Passes 64TB of PractRand with no anomalies.
 */
public class LeaderRandom extends EnhancedRandom {
	...
	/**
	 * Creates a new LeaderRandom with the given two states; all {@code long} values are permitted.
	...
	public long nextLong () {
		long r = (stateA += 0x9E3779B97F4A7C15L);
		long q = (stateB += Long.numberOfLeadingZeros(r));
		r ^= r >>> 27 ^ (q << 21 | q >>> 43);
		r *= 0x3C79AC492BA7B653L;
		r ^= r >>> 33 ^ (q << 41 | q >>> 23);
		r *= 0x1C69B3F74AC4AE35L;
		return r ^ r >>> 27;
	}
	...
	public long previousLong () {
		...
		stateB -= Long.numberOfLeadingZeros(r);
		r ^= r >>> 27 ^ (q << 21 | q >>> 43);
		r *= 0x3C79AC492BA7B653L;
		r ^= r >>> 33 ^ (q << 41 | q >>> 23);
		r *= 0x1C69B3F74AC4AE35L;
