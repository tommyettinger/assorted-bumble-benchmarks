 ...
 * HotSpot Java 8:
 * <br>
 * JupiterRandomBench score: 999178176.000000 (999.2M 2072.2%)
 *               uncertainty:   3.2%
 * <br>
 * OpenJ9 Java 15:
 * <br>
 * JupiterRandomBench score: 718055104.000000 (718.1M 2039.2%)
 *               uncertainty:   0.9%
 * <br>
 * HotSpot Java 16:
 * <br>
 * JupiterRandomBench score: 1876094720.000000 (1.876G 2135.2%)
 *               uncertainty:   0.8%
 */
public final class JupiterRandomBench extends MicroBench {

	public static class JupiterRandom extends Random {
		 ...
		 * @see #setSeed(long)
		 */
		public JupiterRandom(long seed) {
			super(seed);
		...
		public JupiterRandom(long stateA, long stateB, long stateC, long stateD) {
			super(stateA);
			this.stateA = stateA;
			this.stateB = stateB;
			this.stateC = stateC;
		...
		protected int next(int bits) {
			...
			this.stateB = Long.rotateLeft(fa, 47);
			this.stateC = fb + 0xC6BC279692B5C323L;
			this.stateD = fb ^ fc;
...
//			JupiterRandom rng = new JupiterRandom(0L, 0L, 0L, 0L);
//			for (int i = 0; i < 256; i++) {
...
//			long count = 0xffffffL;
			...
			JupiterRandom rand = new JupiterRandom(1234567L);
 ...
 */
	...
	protected long doBatch(long numIterations) throws InterruptedException {
		JupiterRandom rng = new JupiterRandom(0x12345678);
		long sum = 0L;
