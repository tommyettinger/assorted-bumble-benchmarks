...
public class TuftRandom extends EnhancedRandom {
	...
	/**
	 * Creates a new TuftRandom with a random state.
	 */
	public TuftRandom() {
	...
	/**
	 * Creates a new TuftRandom with the given seed; all {@code long} values are permitted.
	 * The seed will be passed to {@link #setSeed(long)} to attempt to adequately distribute the seed randomly.
	 *
	 * @param seed any {@code long} value
	 */
	public TuftRandom(long seed) {
		setSeed(seed);
	}

	/**
	 * Creates a new TuftRandom with the given four states; all {@code long} values are permitted.
	 ...
	 */
	public TuftRandom(long stateA, long stateB, long stateC, long stateD) {
		this.stateA = stateA;
		this.stateB = stateB;
		this.stateC = stateC;
		this.stateD = stateD;
	...
	public int next (int bits) {
		...
		stateB = (fa << 39 | fa >>> 25);
		stateC = fc + 0xF1357AEA2E62A9C5L;
		return (int)(stateD = fa + fb) >>> (32 - bits);
	}

	@Override
	public TuftRandom copy () {
		return new TuftRandom(stateA, stateB, stateC, stateD);
	}
