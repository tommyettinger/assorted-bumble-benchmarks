...
public class TrimPostRandom extends EnhancedRandom {
	 ...
	 */
	public TrimPostRandom(long seed) {
		setSeed(seed);
	}
	 ...
	 */
	public TrimPostRandom(long stateA, long stateB, long stateC, long stateD) {
		this.stateA = stateA;
		this.stateB = stateB;
		this.stateC = stateC;
		this.stateD = stateD;
	...
	@Override
	public TrimPostRandom copy () {
		return new TrimPostRandom(stateA, stateB, stateC, stateD);
	}
	...
	public boolean equals (Object o) {
		...
		TrimPostRandom that = (TrimPostRandom)o;
