 ...
 * HotSpot Java 8:
 * <br>
 * GanymedeRandomBench score: 1016326336.000000 (1.016G 2073.9%)
 *                uncertainty:   1.0%
 * <br>
 * OpenJ9 Java 15:
 * <br>
 * GanymedeRandomBench score: 848136960.000000 (848.1M 2055.9%)
 *                uncertainty:   0.9%
 * <br>
 * HotSpot Java 16:
 * <br>
 * GanymedeRandomBench score: 1699365760.000000 (1.699G 2125.4%)
 *                uncertainty:   0.2%
 */
public final class GanymedeRandomBench extends MicroBench {

	public static class GanymedeRandom extends Random {
		 ...
		 * @see #setSeed(long)
		 */
		public GanymedeRandom(long seed) {
			super(seed);
		...
		public GanymedeRandom(long stateA, long stateB, long stateC, long stateD) {
			super(stateA);
			this.stateA = stateA;
			this.stateB = stateB;
			this.stateC = stateC;
...
//			this.stateA = Long.rotateLeft(fd, 37) + 0xD1342543DE82EF95L;
//			this.stateB = Long.rotateLeft(fc, 47) + fd ^ fa;
//			this.stateC = Long.rotateLeft(fa, 12) + 0xC6BC279692B5C323L;
//			this.stateD = fa ^ fb + fc;
			this.stateA = fa + 0xC6BC279692B5C323L;
			this.stateB = fd * 0xD1342543DE82EF95L;
...
//			GanymedeRandom rng = new GanymedeRandom(0L, 0L, 0L, 0L);
//			for (int i = 0; i < 256; i++) {
...
//			long count = 0xffffffL;
			...
			GanymedeRandom rand = new GanymedeRandom(1234567L);
 ...
 */
	...
	protected long doBatch(long numIterations) throws InterruptedException {
		GanymedeRandom rng = new GanymedeRandom(0x12345678);
		long sum = 0L;
