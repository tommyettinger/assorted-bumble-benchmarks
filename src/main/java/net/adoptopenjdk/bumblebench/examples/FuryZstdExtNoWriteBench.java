 ...
 * <br>
 * FuryZstdExtNoWriteBench score: 109.113747 (109.1 469.2%)
 *                     uncertainty:   1.7%
 */
public final class FuryZstdExtNoWriteBench extends MiniBench {
	@Override
...
//		Fury fury = Fury.builder().withLanguage(Language.JAVA).build();
		...
		try {
			OutputStream stream = new ZstdOutputStreamNoFinalizer(Files.newOutputStream(Paths.get("furyZstdExtNo.dat")), 20);
