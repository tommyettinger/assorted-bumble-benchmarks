 ...
 * <br>
 * ForyZstdExtNoWriteBench score: 109.113747 (109.1 469.2%)
 *                     uncertainty:   1.7%
 */
public final class ForyZstdExtNoWriteBench extends MiniBench {
	@Override
...
//		Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
		...
		try {
			OutputStream stream = new ZstdOutputStreamNoFinalizer(Files.newOutputStream(Paths.get("foryZstdExtNo.dat")), 20);
